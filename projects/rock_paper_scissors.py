...
def play_rps(choice_str: str) -> Dict[str, str]:
    ...
    if user_choice == cpu_choice:
        ...
        and cpu_choice == Choice.SCISSORS
        or user_choice == Choice.PAPER
        and cpu_choice == Choice.ROCK
        or user_choice == Choice.SCISSORS
        and cpu_choice == Choice.PAPER
    ):
        result = "You win!"
    else:
        result = "You lose :("
...
if __name__ == "__main__":
    ...
    print(
        f'You picked {response["user_choice"]}, '
